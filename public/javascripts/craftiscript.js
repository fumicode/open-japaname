...
$(function(){
  //スクロールバーを追加
  $(".ateji-cands-for-kana").perfectScrollbar();

  //changeイベントは、チェックされたところでしか発火しないから、
  //イベントを拡張 -> change2
...
function updateSelectedName(){
  ...
  .map(function(index, el){
    ...
    namearray.push({
      syl_index: el.id.split("_")[2].charAt(1),
      kanji:el.value,
      kana:kana,
      romaji:el.getAttribute("data-romaji"),
      meanings:el.getAttribute("data-meanings").split(',')});
  });
