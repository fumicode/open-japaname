...
riot.tag2('candidate-table', '<table class="syllablesTable"> <tr class="syllablesTable__row" each="{cell in selected_cells}"> <td class="syllablesTable__cell">{cell.syllable.romaji} - {cell.syllable.kana} <ul class="kanjisList"> <li class="kanjisList__item" each="{ateji in cell.syllable.atejis}">{ateji.kanji} <div class="kanjisList__meanings">{ateji.meanings.join(⁗\\n⁗)}</div> </li> </ul> </td> </tr> </table>', 'candidate-table .syllablesTable,[data-is="candidate-table"] .syllablesTable{ } candidate-table .syllablesTable__row,[data-is="candidate-table"] .syllablesTable__row{ } candidate-table .syllablesTable__cell,[data-is="candidate-table"] .syllablesTable__cell{ overflow-x:scroll; } candidate-table .kanjisList,[data-is="candidate-table"] .kanjisList{ width:9999px; overflow:hidden; } candidate-table .kanjisList__item,[data-is="candidate-table"] .kanjisList__item{ float:left; font-size:80px; text-align:center; margin:0 0.3em; } candidate-table .kanjisList__meanings,[data-is="candidate-table"] .kanjisList__meanings{ font-size:20px; }', '', function(opts) {
